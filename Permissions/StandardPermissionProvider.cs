...
namespace Grand.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord ManageShops = new PermissionRecord { Name = "Admin area. Manage Shops", SystemName = PermissionSystemName.Shops, Category = "Shops", Actions = new List<string> { PermissionActionName.List, PermissionActionName.Create, PermissionActionName.Edit, PermissionActionName.Preview, PermissionActionName.Delete } };
        public static readonly PermissionRecord ManageShopInfo = new PermissionRecord { Name = "Shop Admin area. Manage Shop Info", SystemName = PermissionSystemName.ShopInfo, Category = "Shops", Actions = new List<string> { PermissionActionName.List, PermissionActionName.Create, PermissionActionName.Edit, PermissionActionName.Preview, PermissionActionName.Delete } };
        ...
        public virtual IEnumerable<DefaultPermissionRecord> GetDefaultPermissions()
        {
            return new[]
            {
                ...
                new DefaultPermissionRecord
                {
                    CustomerRoleSystemName = SystemCustomerRoleNames.ShopAdmin,
                    PermissionRecords = new[]
                    {
                        AccessAdminPanel,
                        ManageProducts,
