namespace Grand.Services.Security
{
    public static class PermissionSystemName
    {
        ...
        public const string Offers = "ManageOffers";
        public const string Transactions = "ManageTransactions";
        ...
        public const string Shops = "ManageShops";
        public const string ShopInfo = "ManageShopInfo";
